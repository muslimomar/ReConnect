...
public class OldReminderAdapter extends ArrayAdapter<Reminder> {

    private Realm realm;

    public OldReminderAdapter(Context context, List<Reminder> reminders) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        deleteBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Reminder reminderObj = realm.where(Reminder.class)
                        .equalTo("id", id)
                        .findFirst();
                new AlarmScheduler().cancelAlarm(getContext(),reminderObj.getId());
                reminderObj.deleteFromRealm();
