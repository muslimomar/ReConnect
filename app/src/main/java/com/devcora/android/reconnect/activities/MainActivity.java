...
import com.devcora.android.reconnect.fragments.Balance;
import com.devcora.android.reconnect.fragments.Credits;
import com.devcora.android.reconnect.fragments.Home;
import com.devcora.android.reconnect.fragments.Instructions;
import com.devcora.android.reconnect.model.Reminder;
import com.devcora.android.reconnect.reminder.AlarmScheduler;
import com.devcora.android.reconnect.util.Extras;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void selectItemDrawer(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.clear_prefs:
                ...
                break;
            case R.id.website:
                Intent intent = new Intent(Intent.ACTION_VIEW).setData(Uri.parse("http://www.nishahdennison.com/reconnect"));
    ...
    private void logUser() {
        ...
        Crashlytics.setUserEmail("mahmoud.roxy@gmail.com");
        Crashlytics.setUserName("Nishah");
    }
}
